    ...
    m.addLayer(
      {
        ...
        source: 'vehicles-source',
        paint: {
          // ponytail: fixed weight is fine, one vehicle == one unit of density
          'heatmap-weight': 1,
          'heatmap-intensity': ['interpolate', ['linear'], ['zoom'], 10, 3, 14, 5, 18, 8],
          'heatmap-color': [
            'interpolate', ['linear'], ['heatmap-density'],
            0, 'rgba(0,0,0,0)',
            0.05, 'rgba(59,130,246,0.35)',
            0.3, 'rgba(168,85,247,0.55)',
            0.6, 'rgba(236,72,153,0.7)',
            1, 'rgba(250,204,21,0.9)',
          ],
          'heatmap-radius': ['interpolate', ['linear'], ['zoom'], 10, 20, 14, 45, 18, 80],
          'heatmap-opacity': 0.9,
        },
      },
