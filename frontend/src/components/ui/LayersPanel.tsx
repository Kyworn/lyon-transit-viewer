...
export default function LayersPanel() {
  ...
  const transit = [
    ...
    {
      label: 'Chantiers voirie',
      description: 'Travaux perturbant la circulation',
      active: roadworksVisible,
      onToggle: toggleRoadworks,
      color: '#f97316',
      icon: (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
          <path d="M3 20h18M6 20l3-9m9 9l-3-9" />
          <path d="M7 11h10l-1.5-5h-7z" />
        </svg>
      ),
    },
  ];
